...
var a=jQuery.extend({numberOfRowsToRetrieve:10,onSuccessCallback:function(){},onErrorCallback:function(){alert("An error occurred while trying to retrive data from store")},onTimeOutCallback:function(){},timeOut:3E3,autoIncreaseTimeOut:1E3,retryOnTimeOut:!1,loadingButtonText:"Loading...",loadMoreButtonText:"Load more",fullListText:"There is no more items to show",extraParams:null},i),b=jQuery(this),d=!1,g=!1,e;e=null==a.extraParams?{start:0,numberOfRowsToRetrieve:a.numberOfRowsToRetrieve}:{start:0,
numberOfRowsToRetrieve:a.numberOfRowsToRetrieve,extraParams:a.extraParams};b.html("");jQuery(window).scroll(function(){var a=jQuery(this);a.scrollTop()===jQuery(document).height()-a.height()&&!d&&(g=!0,c());return!1});jQuery(document).ready(function(){j();c()})}})(jQuery);